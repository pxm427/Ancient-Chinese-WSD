...
for key in test_vecs.keys():
    ...
    for test_embed in test_vecs[key]:
        ...
        with open('/clwork/xiaomeng/Test/1-NNapproach_fan_sikuBERT/output_avg.txt', 'a+', encoding='utf-8')as f:
    ...
    with open('/clwork/xiaomeng/Test/1-NNapproach_fan_sikuBERT/accuracy_avg.txt', 'a+', encoding='utf-8')as f1:
