...
for key in test_vecs_2.keys():
    ...
    for test_embed in test_vecs_2[key]:
        ...
        with open('/clwork/xiaomeng/Test/1-NNapproach_fan_sikuBERT/output_concat.txt', 'a+', encoding='utf-8')as f:
    ...
    with open('/clwork/xiaomeng/Test/1-NNapproach_fan_sikuBERT/accuracy_concat.txt', 'a+', encoding='utf-8')as f1:
